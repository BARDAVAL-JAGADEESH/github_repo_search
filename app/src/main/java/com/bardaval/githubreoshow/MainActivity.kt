...
fun HomeScreen(navController: NavHostController) {
    ...
    Column(modifier = Modifier.padding(16.dp)) {
        ...
        val repositories by viewModel.repositories // Use delegated property to get latest value
        RepositoryList(repositories, navController)

        // Optional: Display an error message if exists
